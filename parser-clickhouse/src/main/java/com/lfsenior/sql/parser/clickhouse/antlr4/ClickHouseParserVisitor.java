...
public interface ClickHouseParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link ClickHouseParser#addAfterColumnName}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAddAfterColumnName(ClickHouseParser.AddAfterColumnNameContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ClickHouseParser#tableCommentClause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTableCommentClause(ClickHouseParser.TableCommentClauseContext ctx);
	/**
	 * Visit a parse tree produced by {@link ClickHouseParser#columnCommentClause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitColumnCommentClause(ClickHouseParser.ColumnCommentClauseContext ctx);
	/**
